...
linechartResize = ->
  ...
  $("#user-chart").sparkline [160, 240, 250, 280, 300, 320, 360, 420, 450, 500, 550, 600, 660, 720, 800, 880, 950, 1000, 1080, 1800, 2000, 2160, 2220, 3140],
    type: "line"
    width: "100%"
    height: "226"
    lineColor: "#a5e1ff"
  ...
  $("#invite-chart").sparkline [60, 140, 250, 280, 300, 350, 430, 500, 580, 680, 700, 760, 800, 820, 1200, 1500, 2200, 4000, 5180, 7180, 7200, 8160, 8220, 9140],
    type: "line"
    width: "100%"
    height: "226"
    lineColor: "#a5e1ff"
